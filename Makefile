#############################################################################
# Makefile for building: AudioMetadataEditor.app/Contents/MacOS/AudioMetadataEditor
# Generated by qmake (3.1) (Qt 6.6.0)
# Project:  AudioMetadataEditor.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile AudioMetadataEditor.pro -spec macx-clang
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = AudioMetadataEditor1.0.0
DISTDIR = /Users/inquantum-cp-mbpro/AudioMetadataEditor/.tmp/AudioMetadataEditor1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -ltaglib -framework QtWidgets -framework QtMultimedia -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtNetwork -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/macx.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/sanitize.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/gcc-base.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/gcc-base-mac.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/clang.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/clang-mac.conf \
		...
		AudioMetadataEditor.pro wavfile.h main.cpp \
		wavfile.cpp
QMAKE_TARGET  = AudioMetadataEditor
DESTDIR       = 
TARGET        = AudioMetadataEditor.app/Contents/MacOS/AudioMetadataEditor

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.0
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/inquantum-cp-mbpro/AudioMetadataEditor/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/inquantum-cp-mbpro/AudioMetadataEditor/AudioMetadataEditor.pro


include /opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

AudioMetadataEditor.app/Contents/MacOS/AudioMetadataEditor:  $(OBJECTS)  
	@test -d AudioMetadataEditor.app/Contents/MacOS/ || mkdir -p AudioMetadataEditor.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: AudioMetadataEditor.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile AudioMetadataEditor.pro -spec macx-clang
...
AudioMetadataEditor.app/Contents/PkgInfo: 
	@test -d AudioMetadataEditor.app/Contents || mkdir -p AudioMetadataEditor.app/Contents
	@$(DEL_FILE) AudioMetadataEditor.app/Contents/PkgInfo
	@echo "APPL????" > AudioMetadataEditor.app/Contents/PkgInfo
AudioMetadataEditor.app/Contents/Info.plist: 
	@test -d AudioMetadataEditor.app/Contents || mkdir -p AudioMetadataEditor.app/Contents
	@$(DEL_FILE) AudioMetadataEditor.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.AudioMetadataEditor,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.AudioMetadataEditor,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,AudioMetadataEditor,g" -e "s,@LIBRARY@,AudioMetadataEditor,g" -e "s,\$${EXECUTABLE_NAME},AudioMetadataEditor,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >AudioMetadataEditor.app/Contents/Info.plist

all: Makefile \
		AudioMetadataEditor.app/Contents/PkgInfo \
		AudioMetadataEditor.app/Contents/Info.plist AudioMetadataEditor.app/Contents/MacOS/AudioMetadataEditor
...
distdir: FORCE
	...
	$(COPY_FILE) --parents wavfile.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp wavfile.cpp $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r AudioMetadataEditor.app
...
main.moc: main.cpp \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/inquantum-cp-mbpro/AudioMetadataEditor/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/inquantum-cp-mbpro/AudioMetadataEditor -I/usr/include/qt/QtMultimedia -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtMultimedia.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib main.cpp -o main.moc
